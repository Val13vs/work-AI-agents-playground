...
export const tickets: Ticket[] = [
    {
        ...
        description:
            'Implement a search page for locations using the Locations API.',
        status: 'IN_PROGRESS',
        requirements: [
    ...
    },
    {
        ...
        description:
            'Add server-side pagination to the Events page.',
        status: 'OPEN',
        requirements: [
            'Use lazy loading',
    ...
    },
    {
        ...
        description:
            'Improve validation rules in the user management form.',
        status: 'OPEN',
        requirements: [
